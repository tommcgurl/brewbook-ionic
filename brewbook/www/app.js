...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('tab.styles', {
    ...
    views: {
      'tab-styles' : {
        templateUrl: 'layout/styles/styles.template.html',
        controller: 'Styles as vm'
      }
    }
  })
  .state('tab.brews-by-style', {
    url: '/styles/:style',
    views: {
      'tab-styles' : {
        templateUrl: 'layout/brewsByStyle/brewsByStyle.template.html',
